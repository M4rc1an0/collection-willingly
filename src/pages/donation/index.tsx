            ...
            <S.ContentTop>
                ...
                <S.ContentBox>
                    ...
                    <S.ContentFlex>
                        ...
                        <Button active={buttonFood} action={() => { setValueStorage("food"), setButtonFood(true) }} text="Alimentos e Outros" icon={<Resources width={48} stroke="#FF844B" />} />
                    ...
                    {render === "clothes" &&
                        <>
                            <S.chooseOption>Alimentos, Remédios, Materiais didático e Outros:</S.chooseOption>
                            <S.ContentSpace>
